...
config: dict[str, [float, int, str, dict]] = {
    ...
    "extra_condition_module": T5EncoderModel.from_pretrained(
        extractor,
        torch_dtype="auto",
    ...
    "model_config": {
        ...
        "condition_dim": (num_texts, max_text_length, 768),
        "kernel_size": 9,
    },
}
