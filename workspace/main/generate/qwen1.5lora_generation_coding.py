...
dataset_tag = "Glaive-Code-Assistant-V2"
...
def main(eval_dataset: str, test_dataset: str):
    ...
    for i in range(config["real_length"]):
        ...
        subprocess.run(["python", "./benchmark/human-eval/vllm_infer.py"] + args)
        subprocess.run(
            [
